...
import { ActivityIndicator, NativeSyntheticEvent, StyleSheet, Text, TextInputChangeEventData, View, ScrollView } from "react-native"
...
const World: React.FC = () => {
    ...
    const { data, isFetching, refetch } = useQuery(["world", text], async () => {
